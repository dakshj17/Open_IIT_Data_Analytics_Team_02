...
def plot_chi_square_heatmap(contingency, var1_name="Variable 1", var2_name="Variable 2", top_n=10):  # 
    """
...
def dataset_vanity_checks(df): #-may remove depending on whether the cleaning needs vanity checks
