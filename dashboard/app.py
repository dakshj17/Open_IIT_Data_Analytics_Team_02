...
with tabs[6]:
    ...
    with left:
        ...
        st.markdown(
            """
1) **Emerging hubs:** Latvia, Puerto Rico, Estonia, Malta, UAE, Cyprus, South Africa, Slovakia, Greece, Croatia.  
2) **Top genres (Movies & TV):** Adventure, Science Fiction, Action.  
3) **Slate skew:** Adult-heavy (>40% R, ~30% PG-13) while family co-viewing is strong in India/SEA/LATAM; rivals dominate family.
            """
        )
    ...
    with right:
        ...
        st.markdown(
            """
1) **Source more titles** from these 10 regions to lift engagement & diversity.  
2) **Double down** on Adventure/Sci-Fi/Action via licenses + co-pros to grow viewership & revenue.  
3) **Rebalance toward family:** add PG/PG-13 localized titles and feature dedicated family rows to reduce churn.
            """
        )
